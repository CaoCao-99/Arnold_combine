...
def main(cfg):
    ...
    if cfg.novel:
        train_dataset = ArnoldDataset(data_path=os.path.join(cfg.any_state, cfg.task, 'any_state'), task=cfg.task, obs_type=cfg.obs_type)
    else:
        if cfg.task == 'multi':
    ...
    if cfg.resume:
        if os.path.isfile(cfg.resume):
            ...
            start_step = agent.load_model(cfg.resume, DEVICE)
